          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Flexible(child: _buildQuickButton(context, '1km', 1000)),
                  const SizedBox(width: 4),
                  Flexible(child: _buildQuickButton(context, '2km', 2000)),
                  const SizedBox(width: 4),
                  Flexible(child: _buildQuickButton(context, '5km', 5000)),
                  const SizedBox(width: 4),
                  Flexible(child: _buildQuickButton(context, '10km', 10000)),
                ],
              ),
            ],
          ),
