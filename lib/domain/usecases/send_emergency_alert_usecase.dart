...
final sendEmergencyAlertUseCaseProvider = Provider<SendEmergencyAlertUseCase>((ref) {
...
class SendEmergencyAlertUseCase {
  ...
  Future<void> execute({
    ...
    try {
      log('Sending emergency alert to contacts', name: 'SendEmergencyAlertUseCase');
      ...
      log('Emergency alert sent successfully', name: 'SendEmergencyAlertUseCase');
    } catch (e) {
      log('Error sending emergency alert: $e', name: 'SendEmergencyAlertUseCase');
      rethrow;
    }
  }
}
