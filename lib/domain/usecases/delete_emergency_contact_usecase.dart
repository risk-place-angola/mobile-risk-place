...
final deleteEmergencyContactUseCaseProvider = Provider<DeleteEmergencyContactUseCase>((ref) {
...
class DeleteEmergencyContactUseCase {
  ...
  DeleteEmergencyContactUseCase({required IEmergencyContactRepository repository})
      : _repository = repository;

  Future<void> execute(String id) async {
    try {
      log('Deleting emergency contact: $id', name: 'DeleteEmergencyContactUseCase');
      await _repository.deleteContact(id);
      log('Contact deleted successfully', name: 'DeleteEmergencyContactUseCase');
    } catch (e) {
