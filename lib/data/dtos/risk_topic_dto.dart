class RiskTopicDTO {
  ...
  factory RiskTopicDTO.fromJson(Map<String, dynamic> json) {
    return RiskTopicDTO(
...
class ListRiskTopicsResponseDTO {
  final List<RiskTopicDTO> data;

  const ListRiskTopicsResponseDTO({
    required this.data,
  });
  ...
  factory ListRiskTopicsResponseDTO.fromJson(Map<String, dynamic> json) {
    ...
    return ListRiskTopicsResponseDTO(
      data: dataList
          .map((item) => RiskTopicDTO.fromJson(item as Map<String, dynamic>))
          .toList(),
    );
  }
